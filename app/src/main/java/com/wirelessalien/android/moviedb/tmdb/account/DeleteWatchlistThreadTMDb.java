...
public class DeleteWatchlistThreadTMDb extends Thread {
    ...
    public DeleteWatchlistThreadTMDb(String sessionId, int movieId, int accountId, String type, Activity activity) {
