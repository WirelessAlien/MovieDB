...
public class DeleteFavouriteThreadTMDb extends Thread {
    ...
    public DeleteFavouriteThreadTMDb(String sessionId, int movieId, int accountId, String type, Activity activity) {
